...
example16<-read.csv("/work/xwang35/data/example16.csv",header=TRUE)
ex16_500 = foreach(i=1:1000, 
                  .combine="cbind", 
                  .packages=c("oem","dplyr","dtplyr")) %dopar% {
                    d<-sample_n(example16,2000) 
...
write.csv(x=ex16_500,file="example16_2000.csv")
